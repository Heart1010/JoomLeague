...
<form action="index.php" method="post" id="adminForm" name="adminForm">
	...
	if(	JFactory::getUser()->authorise('core.admin', 'com_joomleague') || JFactory::getUser()->authorise('core.admin', 'com_joomleague.project.'.(int)$this->projectws->id)) {
