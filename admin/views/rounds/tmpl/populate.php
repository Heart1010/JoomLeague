...
<form method="post" id="adminForm" name="adminForm" action="<?php echo $this->request_url; ?>">
	...
	<legend><?php echo JText::sprintf('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_LEGEND','<i>'.$this->projectws->name.'</i>'); ?></legend>
		...
		<tr>
			<td nowrap='nowrap' class="key hasTip" title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_MATCHNUMBER_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_MATCHNUMBER_TIP'); ?>">
