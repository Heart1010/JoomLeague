	...
	<table width="96%" align="center" border="0" cellpadding="0" cellspacing="5">
		...
		if ($this->inprojectinfo->injury > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$injury_date = JHtml::date($this->roundsdata[$this->inprojectinfo->injury_date]['date_first'] .' UTC', 
												JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
				...
				{
					$injury_end = JHtml::date($this->roundsdata[$this->inprojectinfo->injury_end]['date_last'] .' UTC', 
												JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
												JoomleagueHelper::getTimezone($this->project, $this->overallconfig));
		...
		if ($this->inprojectinfo->suspension > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$suspension_date = JHtml::date($this->roundsdata[$this->inprojectinfo->suspension_date]['date_first'] .' UTC', 
													JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
													JoomleagueHelper::getTimezone($this->project, $this->overallconfig));
				...
				{
					$suspension_end = JHtml::date($this->roundsdata[$this->inprojectinfo->suspension_end]['date_last'] .' UTC',
													JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
													JoomleagueHelper::getTimezone($this->project, $this->overallconfig));
		...
		if ($this->inprojectinfo->away > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$away_date = JHtml::date($this->roundsdata[$this->inprojectinfo->away_date]['date_first'] .' UTC', 
												JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
												JoomleagueHelper::getTimezone($this->project, $this->overallconfig));
				...
				{
					$away_end = JHtml::date($this->roundsdata[$this->inprojectinfo->away_end]['date_last'] .' UTC', 
											JText::_('COM_JOOMLEAGUE_BASIC_CALENDAR_DATE'), 
											JoomleagueHelper::getTimezone($this->project, $this->overallconfig));
